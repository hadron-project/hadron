...
use crate::{
    ...
    discovery::{Discovery, ObservedPeersChangeset},
...
impl Network {
    ...
    pub(super) fn send_outbound_peer_request(&mut self, msg: OutboundPeerRequest, _: &mut Context<Self>) -> impl Future<Item=peer::Response, Error=()> {
...
pub(super) enum PeerHandshakeState {
...
pub(super) struct PeerConnectionLive {
...
#[derive(Message)]
pub(super) struct DisconnectPeer;
...
pub(super) struct GetRoutingInfo;
...
pub(super) enum ClientConnectionUpdate {
