...
//             }
//             AppDataError::UnknownStream { namespace, name } => {
//                 ClientError::new_unknown_stream(namespace, name)
//             }
...
//         Self {
//             response: Some(client::connect_response::Response::Id(id)),
//         }
//     }
...
//         Self {
//             response: Some(client::connect_response::Response::Error(err)),
//         }
//     }
// }
...
//         Self {
//             result: Some(client::pub_stream_response::Result::Index(idx)),
//         }
//     }
...
//     pub fn new_err(err: ClientError) -> Self {
//         Self {
//             result: Some(client::pub_stream_response::Result::Error(err)),
//         }
//     }
// }
